...
## Logs
Logs are written to a file `<current-dir>/minchu-logs/after-effects.log`. Timestamps in the logs may not be accurate because some commands buffer the stdout outputs.
