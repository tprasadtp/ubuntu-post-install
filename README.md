...
Its in the pipeline, but I cannot guarantee anything. Since I do not use anything other than Open SUSE very often, so it might take a while. But you can modify this repository very easily to achieve that. You need to do the following things,
