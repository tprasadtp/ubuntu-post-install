...
The configuration file is pretty much self explanatory so, I am going to just post a sample config file below. All boolean fields are optional and if not provided or if invalid fallback to false.
